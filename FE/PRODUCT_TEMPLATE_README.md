# Product Template Download Feature

Tính năng download template sản phẩm với đầy đủ các trường từ Product và ProductDetail entities.

## 📋 Template Structure

Template được tạo dưới dạng file CSV với các cột sau:
...
- `weight` - Trọng lượng (kg, số thập phân)
...
- File `product_template.csv` sẽ được tải về
...
- **Encoding:** UTF-8
- **Delimiter:** Dấu phẩy (`,`)
- **Quote character:** Dấu ngoặc kép (`"`) cho text chứa dấu phẩy
...
### **Error Handling:**
- File không đúng định dạng sẽ báo lỗi
- Dữ liệu không hợp lệ sẽ được đánh dấu và báo lỗi chi tiết
- Có thể preview dữ liệu trước khi import thực tế
