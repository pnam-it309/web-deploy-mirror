<template>
  <div
    ...
    <div class="p-4">
      ...
      <div class="flex justify-between items-center pt-2 border-t border-gray-100"> <span
          class="inline-flex items-center text-sm" :class="product.inStock ? 'text-green-600' : 'text-red-600'">
          <span class="w-2 h-2 rounded-full mr-1" :class="product.inStock ? 'bg-green-500' : 'bg-red-500'"></span>
          {{ product.inStock ? 'In Stock' : 'Out of Stock' }}
        </span>

        <Button variant="ghost" size="sm" class="text-indigo-600 hover:bg-indigo-50"
