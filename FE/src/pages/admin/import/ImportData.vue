<template>
  <div class="container mx-auto p-4">
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
      <ImportDataFilter @search="handleSearch" @reset="handleReset" />
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <ImportDataTable :items="importData" :loading="isLoading" @edit="handleEdit" @delete="handleDelete" />
    </div>
    ...
    <div v-if="showUploadModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div class="bg-white rounded-lg w-full max-w-md p-6">
        ...
        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
          <input type="file" ref="fileInput" @change="handleFileChange" class="hidden" accept=".xlsx, .xls, .csv" />
          <div class="flex flex-col items-center">
            ...
            <button @click="fileInput?.click()" class="text-blue-600 font-medium hover:text-blue-800"> Chọn file
            </button>
        ...
        <div class="mt-6 flex justify-end space-x-3">
          ...
          <button @click="uploadFile" :disabled="!selectedFile || isUploading" :class="{
...
const fetchImportData = async (params = {}) => {
  try {
    ...
    const response = await request.get('/api/v1/import_data');
...
const handleDelete = async (id: string) => {
  ...
  try {
    // Replace with your actual API call
    await request.delete(`/api/v1/import_data/${id}`);
...
const uploadFile = async () => {
  ...
  try {
    ...
    // Replace with your actual API call
    const response = await request.post('/api/v1/import_data/upload', formData, {
      headers: {
