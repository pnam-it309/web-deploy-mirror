<template>
  <div class="order-list">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <router-link
      to="/admin/orders/new"
      class="inline-flex items-center m-4 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 "
    >
      + Tạo đơn hàng mới
    </router-link>
      <!-- Orders Table -->
  ...
  setup() {
    ...
    const orders = ref([
      ...
      },
      {
        ...
        items: [{ id: 9, name: 'Bộ đồ thể thao', quantity: 2, price: 1600000, total: 3200000 }],
      },
    ])
