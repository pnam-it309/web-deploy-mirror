        ...
        <div class="border-t border-gray-200 pt-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-2">
              ...
              <input type="text" id="address" v-model="formData.address.street"
                class="form-input w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
              ...
              <input type="text" id="state" v-model="formData.address.state"
                class="form-input w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
              <label for="postalCode" class="block text-sm font-medium text-gray-700 mb-1">Mã bưu điện</label>
              <input type="text" id="postalCode" v-model="formData.address.postalCode"
                class="form-input w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            </div>
