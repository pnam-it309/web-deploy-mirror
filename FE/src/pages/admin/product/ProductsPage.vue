...
import { getAllProducts, ParamsGetProduct, ProductsResponse } from '@/services/api/admin/product.api'
import { BrandResponse, getAllBrand } from '@/services/api/admin/brand.api'
import { getAllCategory,CategoryResponse } from '@/services/api/admin/category.api'
...
watch(
  () => [state.skuOrName, state.categoryId, state.brandId, state.status],
  () => {
   state.page = 1
