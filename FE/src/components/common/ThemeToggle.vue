<template>
  <div class="relative group">
    <button @click="toggleTheme"
      class="theme-toggle p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300">
      <!-- Sun Icon (Light Mode) -->
    ...
    <div
      ...
      <div class="absolute bottom-full right-3 border-[6px] border-transparent border-b-gray-900/95"></div>
    </div>
  </div>
</template>
