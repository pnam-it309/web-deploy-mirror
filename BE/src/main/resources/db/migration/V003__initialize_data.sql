-- Phase 3: Initial Data Seed
-- Merged from old V004 and V005
...
-- 1. Insert Domains
-- ----------------------------
DELETE FROM `domains` WHERE `id` IN ('d0000000-0000-0000-0000-000000000001','d0000000-0000-0000-0000-000000000002','d0000000-0000-0000-0000-000000000003','d0000000-0000-0000-0000-000000000004');
...
-- 3. Insert Apps
-- ----------------------------
DELETE FROM `apps` WHERE `id` IN ('a0000000-0000-0000-0000-000000000001','a0000000-0000-0000-0000-000000000002','a0000000-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000004','a0000000-0000-0000-0000-000000000005','a0000000-0000-0000-0000-000000000006');

INSERT INTO `apps` (`id`, `created_at`, `last_modified_date`, `status`, `version`, `domain_id`, `name`, `sku`, `short_description`, `thumbnail`, `view_count`, `is_featured`, `homepage_sort_order`, `approval_status`, `meta_title`, `meta_description`, `meta_keywords`, `publish_at`) VALUES
('a0000000-0000-0000-0000-000000000001', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000001', 'FPL Student Attendance', 'ATT-001', 'Hệ thống điểm danh sinh viên FPL', 'https://img.youtube.com/vi/ffn-vYxPXlA/maxresdefault.jpg', 120, b'1', 1, 'APPROVED', 'FPL Student Attendance', 'Hệ thống điểm danh', 'attendance, fpl', UNIX_TIMESTAMP()*1000),
('a0000000-0000-0000-0000-000000000002', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000002', 'FPL Scrum Helper', 'SCR-001', 'Công cụ hỗ trợ quản lý dự án theo mô hình Agile/Scrum', 'https://img.youtube.com/vi/QBcDDEY7Nrg/maxresdefault.jpg', 95, b'1', 2, 'APPROVED', 'FPL Scrum Helper', 'Quản lý dự án Scrum', 'scrum, agile, project', UNIX_TIMESTAMP()*1000),
('a0000000-0000-0000-0000-000000000003', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000003', 'FPL Sell OpenSource', 'SEL-001', 'Hệ thống bán hàng và quản lý kho', 'https://img.youtube.com/vi/HQPwbLLFaKE/maxresdefault.jpg', 150, b'1', 3, 'APPROVED', 'FPL Sell', 'Hệ thống bán hàng', 'sell, ecommerce', UNIX_TIMESTAMP()*1000),
('a0000000-0000-0000-0000-000000000004', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000001', 'FPL Auto Grading System', 'GRD-001', 'Hệ thống chấm điểm tự động cho sinh viên UDPM', NULL, 80, b'0', NULL, 'APPROVED', 'Auto Grading', 'Chấm điểm tự động', 'grading, auto', UNIX_TIMESTAMP()*1000),
('a0000000-0000-0000-0000-000000000005', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000004', 'FPL Confess Poly 2', 'CFS-002', 'Cổng thông tin Confessions cho sinh viên Poly', NULL, 200, b'0', NULL, 'APPROVED', 'FPL Confess', 'Confessions Poly', 'confess, social', UNIX_TIMESTAMP()*1000),
('a0000000-0000-0000-0000-000000000006', UNIX_TIMESTAMP()*1000, UNIX_TIMESTAMP()*1000, 0, 0, 'd0000000-0000-0000-0000-000000000003', 'FPL Hotel Management', 'HTL-001', 'Hệ thống quản lý khách sạn', NULL, 60, b'0', NULL, 'APPROVED', 'Hotel Management', 'Quản lý khách sạn', 'hotel, management', UNIX_TIMESTAMP()*1000);

-- ----------------------------
-- 4. Insert App Details
-- ----------------------------
DELETE FROM `app_details` WHERE `id` IN ('ad000000-0000-0000-0000-000000000001','ad000000-0000-0000-0000-000000000002','ad000000-0000-0000-0000-000000000003','ad000000-0000-0000-0000-000000000004','ad000000-0000-0000-0000-000000000005','ad000000-0000-0000-0000-000000000006');
...
-- ----------------------------
DELETE FROM `app_technologies` WHERE `app_id` IN ('a0000000-0000-0000-0000-000000000001','a0000000-0000-0000-0000-000000000002','a0000000-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000004','a0000000-0000-0000-0000-000000000005','a0000000-0000-0000-0000-000000000006');
