...
public class AdminFeatureController {
    ...
    public ResponseEntity<?> getAllByAppId(@PathVariable String appId) {
        return Helper.createResponseEntity(ResponseObject.successForward(
                adminFeatureService.getAllByAppId(appId),
                "Lấy danh sách chức năng theo sản phẩm thành công"));
    }
    ...
    public ResponseEntity<?> create(@RequestBody AdminCreateFeatureRequest request) {
        String id = adminFeatureService.create(request);
        if (id != null) {
            return Helper.createResponseEntity(ResponseObject.successForward(
                    id,
    ...
    public ResponseEntity<?> uploadImage(@PathVariable String id,
        ...
        String url = adminFeatureService.uploadImage(id, file);
        return Helper.createResponseEntity(ResponseObject.successForward(
                url,
                "Upload ảnh chức năng thành công"));
    }
}
